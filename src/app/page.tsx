        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <Link href="/library">
              ...
              >
                <h4 className="font-bold mb-1" style={{ color: "var(--background)" }}>Browse Available Books</h4>
                <p className="text-sm" style={{ color: "var(--background)", opacity: 0.6 }}>Access e-books and resources in PDF format</p>
              </motion.div>
            </Link>
          </motion.div>
        </div>
