...
export const metadata = {
    ...
    twitter: {
        ...
        title: "Unblinking — Children of the Olive Book 2",
        description: "What if the reality you knew is being systematically erased?",
        images: ["/books/unblinking.jpg"],
    },
};
        ...
        <div className="min-h-screen bg-black text-white selection:bg-red-500/30 font-sans tracking-tight">
            ...
            <main className="pt-32 pb-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center justify-between">
                <div className="flex-1 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both">
                    <div className="space-y-4">
                        <h4 className="text-red-600 font-medium tracking-[0.2em] uppercase text-sm">Children of the Olive • Book 2 • Free Ebook</h4>
                        <h1 className="text-5xl md:text-7xl font-bold leading-tight tracking-tighter">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-700 to-red-500">Unblinking</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-white/70 font-light max-w-2xl leading-relaxed">
                            You can&apos;t forget what was never real. But what if the reality you knew is being systematically erased?
                        </p>
                    </div>

                    <div className="flex items-center gap-6 pt-4">
                        <Link
                            href="https://www.lulu.com/search?page=1&q=Unblinking+Sajjad+Rasool"
                            target="_blank"
                ...
                <div className="flex-1 flex justify-center lg:justify-end animate-in fade-in slide-in-from-right-8 duration-1000 delay-300 fill-mode-both">
                    <BookMockup coverSrc="/books/unblinking.jpg" spineTitle="UNBLINKING" />
                </div>
            </main>
                ...
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="text-center space-y-6">
                        ...
                        <p className="text-2xl md:text-3xl font-serif italic text-white/90 leading-relaxed">
                            &quot;The Supervisor calls these ghosts &apos;Hollow Ones&apos; — unstable data packets slated for deletion.&quot;
                        </p>
                    </div>

                    <div className="prose prose-invert prose-lg md:prose-xl mx-auto space-y-6 text-white/70 font-light leading-loose">
                        <p>
                            In the rift valley, the trauma of occupation has mutated into the cosmic horror of the Supervisor: a technological entity capable of performing a &quot;Total Re-Format&quot; on reality itself. Its ultimate goal is to delete history, memory, and the very concept of resistance.
                        </p>
                        <p>
                            For Amal and her family, the nightmare is specific: they are trapped in a single, repeating instant of their death — endlessly stalked by the silent, towering silhouette of The Watcher. Their only hope lies in the Bitter Well, the &quot;Hardware Layer&quot; of the earth.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-zinc-950 border-t border-white/5">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center tracking-tight text-white/90">The Nightmare Deepens</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <TopicCard title="The Total Re-Format" description="A technological entity capable of deleting reality itself — history, memory, and resistance." />
                        <TopicCard title="The Time Loop" description="Trapped in a repeating instant, forever stalked by the silent silhouette of The Watcher." />
                        <TopicCard title="The 0th Frequency" description="The Land's Immune System — a brass key broadcasting defiance from the earth's hardware layer." />
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-black border-t border-white/10">
                <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-white/90 font-medium">Children of the Olive #2</p>
                    </div>
                    <div className="space-y-2">
