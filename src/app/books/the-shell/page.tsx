...
export const metadata = {
    ...
    twitter: {
        ...
        title: "The Shell — Spiral Arms Book 1 by Sajjad Rasool",
        description: "The planet isn't dead. It's holding its breath.",
        images: ["/books/the-shell.jpg"],
    },
};
        ...
        <div className="min-h-screen bg-black text-white selection:bg-cyan-500/30 font-sans tracking-tight">
            ...
            <main className="pt-32 pb-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center justify-between">
                <div className="flex-1 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both">
                    <div className="space-y-4">
                        <h4 className="text-cyan-500 font-medium tracking-[0.2em] uppercase text-sm">The Spiral Arms • Book 1 • Free Ebook</h4>
                        <h1 className="text-5xl md:text-7xl font-bold leading-tight tracking-tighter">
                            The <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-cyan-400">Shell</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-white/70 font-light max-w-2xl leading-relaxed">
                            The planet isn&apos;t dead. It&apos;s holding its breath.
                        </p>
                    </div>

                    <div className="flex items-center gap-6 pt-4">
                        <Link
                            href="https://www.lulu.com/search?page=1&q=The+Shell+Sajjad+Rasool"
                            target="_blank"
                ...
                <div className="flex-1 flex justify-center lg:justify-end animate-in fade-in slide-in-from-right-8 duration-1000 delay-300 fill-mode-both">
                    <BookMockup coverSrc="/books/the-shell.jpg" spineTitle="THE SHELL" />
                </div>
            </main>
                ...
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="text-center space-y-6">
                        ...
                        <p className="text-2xl md:text-3xl font-serif italic text-white/90 leading-relaxed">
                            &quot;They aren&apos;t on a dead rock. They&apos;re on the shell of a sentient giant.&quot;
                        </p>
                    </div>

                    <div className="prose prose-invert prose-lg md:prose-xl mx-auto space-y-6 text-white/70 font-light leading-loose">
                        <p>
                            For 200 years, the mining colony on Vastara has been living a lie. The administration told the colonists the massive Seismic Dampers were for earthquake protection. They lied. The Dampers were built to silence the regular, rhythmic THUMP beneath the crust—the sound of a planet that is terrifyingly alive.
                        </p>
                        <p>
                            When the Dampers fail, geologist Dr. Kavi Okonkwo realizes the chilling truth: they&apos;re on the shell of a SENTIENT GIANT, and its distress is about to tear the colony apart. Her only hope lies in finding a way to communicate without losing the very essence of humanity.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-zinc-950 border-t border-white/5">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center tracking-tight text-white/90">For Fans Of</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <TopicCard title="The Expanse" description="Hard science and tense geopolitics in a claustrophobic colony setting on a sentient world." />
                        <TopicCard title="Annihilation" description="High-concept biological mystery — what happens when the ground beneath you is alive and aware?" />
                        <TopicCard title="Dead Space" description="Claustrophobic survival horror as infrastructure crumbles and the planet demands contact." />
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-black border-t border-white/10">
                <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
                    <div className="space-y-2">
                        ...
                        <p className="text-white/90 font-medium">Dec 18, 2025</p>
                    </div>
                    <div className="space-y-2">
                        <h5 className="text-white/40 uppercase tracking-widest text-xs">Series</h5>
                        <p className="text-white/90 font-medium">Spiral Arms #1</p>
                    </div>
                    <div className="space-y-2">
