...
export const metadata = {
    ...
    twitter: {
        ...
        title: "His Last Day by Sajjad Rasool",
        description: "A deeply moving biographical account of a man's final day on earth.",
        images: ["/books/his-last-day.jpg"],
    },
};
        ...
        <div className="min-h-screen bg-black text-white selection:bg-amber-500/30 font-sans tracking-tight">
            ...
            <main className="pt-32 pb-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center justify-between">
                <div className="flex-1 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both">
                    <div className="space-y-4">
                        <h4 className="text-amber-500 font-medium tracking-[0.2em] uppercase text-sm">Biographies & Memoirs • Free Ebook</h4>
                        <h1 className="text-5xl md:text-7xl font-bold leading-tight tracking-tighter">
                            His Last <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-amber-400">Day</span>
                        </h1>
                    ...
                    <div className="flex items-center gap-6 pt-4">
                        <Link
                            href="https://www.lulu.com/search?page=1&q=His+Last+Day+Sajjad+Rasool"
                            target="_blank"
                        ...
                        <div className="text-white/50 text-sm flex flex-col font-light">
                            ...
                            <span>Historical Nonfiction</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 flex justify-center lg:justify-end animate-in fade-in slide-in-from-right-8 duration-1000 delay-300 fill-mode-both">
                    <BookMockup coverSrc="/books/his-last-day.jpg" spineTitle="HIS LAST DAY" />
                </div>
            </main>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-zinc-950 border-t border-white/5">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center tracking-tight text-white/90">Inside This Book</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <TopicCard title="The Final Speech" description="His prophetic 'I've Been to the Mountaintop' speech—an improvised sermon of hope and defiance that eerily foretells his fate." />
                        <TopicCard title="The Lorraine Motel" description="Huddled in the motel's dim rooms with Ralph Abernathy and Andrew Young, wrestling tactical debates over nonviolent marches." />
                        <TopicCard title="The Memphis Strike" description="The 'I Am a Man' sanitation workers' strike's moral fire that brought King to Memphis for the last time." />
                        <TopicCard title="The Human Behind the Legend" description="A weary leader, shadowed by bomb threats and fractured marches, yet fueled by unyielding faith and fierce camaraderie." />
                        <TopicCard title="The Shot That Shattered Eternity" description="The frantic hospital vigil, the shattering confirmation, and the funeral procession that gripped a mourning nation." />
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-black border-t border-white/10">
                <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
                    <div className="space-y-2">
                        ...
                        <p className="text-white/90 font-medium">Nov 28, 2025</p>
                    </div>
                    <div className="space-y-2">
                        <h5 className="text-white/40 uppercase tracking-widest text-xs">ISBN</h5>
                        <p className="text-white/90 font-medium">9781105980756</p>
                    </div>
                    <div className="space-y-2">
