...
export const metadata = {
    ...
    twitter: {
        ...
        title: "The Choice — Spiral Arms Book 3 by Sajjad Rasool",
        description: "The trilogy ends not with a whimper, but with a riot.",
        images: ["/books/the-choice.jpg"],
    },
};
        ...
        <div className="min-h-screen bg-black text-white selection:bg-cyan-500/30 font-sans tracking-tight">
            ...
            <main className="pt-32 pb-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center justify-between">
                <div className="flex-1 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both">
                    <div className="space-y-4">
                        <h4 className="text-cyan-500 font-medium tracking-[0.2em] uppercase text-sm">The Spiral Arms • Book 3 • Free Ebook</h4>
                        <h1 className="text-5xl md:text-7xl font-bold leading-tight tracking-tighter">
                            The <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-cyan-400">Choice</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-white/70 font-light max-w-2xl leading-relaxed">
                            The trilogy ends not with a whimper, but with a riot.
                        </p>
                    </div>

                    <div className="flex items-center gap-6 pt-4">
                        <Link
                            href="https://www.lulu.com/search?page=1&q=The+Choice+Sajjad+Rasool"
                            target="_blank"
                ...
                <div className="flex-1 flex justify-center lg:justify-end animate-in fade-in slide-in-from-right-8 duration-1000 delay-300 fill-mode-both">
                    <BookMockup coverSrc="/books/the-choice.jpg" spineTitle="THE CHOICE" />
                </div>
            </main>
                ...
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="text-center space-y-6">
                        ...
                        <p className="text-2xl md:text-3xl font-serif italic text-white/90 leading-relaxed">
                            &quot;Can the messy, unedited truth of a human soul defeat the flawless logic of the cosmos?&quot;
                        </p>
                    </div>

                    <div className="prose prose-invert prose-lg md:prose-xl mx-auto space-y-6 text-white/70 font-light leading-loose">
                        <p>
                            For seventy long years, the remnants of humanity on Vastara have lived under the &quot;Permanent Lock,&quot; isolated from the galactic core. But the children of the Decoupled generation have inherited a revolution. Led by Leo and the spirit of their ancestors, the survivors are building the ultimate vessel: The Great Ark.
                        </p>
                        <p>
                            From the fierce Battle of the Margin to the first, fragile meeting with the &quot;Alpha,&quot; humanity carries one desperate message to the stars: We are the draft that refused to close. The Spire has fallen, but the Spiral is just beginning to turn.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-zinc-950 border-t border-white/5">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center tracking-tight text-white/90">The Final Draft</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <TopicCard title="Generational Revolution" description="The children inherit more than salt-laced earth — they inherit a revolution against cosmic perfection." />
                        <TopicCard title="The Great Ark" description="Humanity gathers the last, heavy pieces of history to construct the ultimate vessel for survival." />
                        <TopicCard title="The True Cost of Perfection" description="A grand, philosophical journey about whether the unedited truth of humanity can defeat cosmic logic." />
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-black border-t border-white/10">
                <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
                    <div className="space-y-2">
                        ...
                        <p className="text-white/90 font-medium">Dec 23, 2025</p>
                    </div>
                    <div className="space-y-2">
                        <h5 className="text-white/40 uppercase tracking-widest text-xs">Series</h5>
                        <p className="text-white/90 font-medium">Spiral Arms #3</p>
                    </div>
                    <div className="space-y-2">
