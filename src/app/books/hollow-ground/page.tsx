...
export const metadata = {
    ...
    twitter: {
        ...
        title: "Hollow Ground — Children of the Olive Book 5",
        description: "Unearth the horror that refuses to be forgotten.",
        images: ["/books/hollow-ground.jpg"],
    },
};
        ...
        <div className="min-h-screen bg-black text-white selection:bg-red-500/30 font-sans tracking-tight">
            ...
            <main className="pt-32 pb-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center justify-between">
                <div className="flex-1 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both">
                    <div className="space-y-4">
                        <h4 className="text-red-600 font-medium tracking-[0.2em] uppercase text-sm">Children of the Olive • Book 5 • Free Ebook</h4>
                        <h1 className="text-5xl md:text-7xl font-bold leading-tight tracking-tighter">
                            Hollow <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-700 to-red-500">Ground</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-white/70 font-light max-w-2xl leading-relaxed">
                            Unearth the horror that refuses to be forgotten.
                        </p>
                    </div>

                    <div className="flex items-center gap-6 pt-4">
                        <Link
                            href="https://www.lulu.com/search?page=1&q=Hollow+Ground+Sajjad+Rasool"
                            target="_blank"
                        ...
                        <div className="text-white/50 text-sm flex flex-col font-light">
                            ...
                            <span>Literary Gothic Fiction</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 flex justify-center lg:justify-end animate-in fade-in slide-in-from-right-8 duration-1000 delay-300 fill-mode-both">
                    <BookMockup coverSrc="/books/hollow-ground.jpg" spineTitle="HOLLOW GROUND" />
                </div>
            </main>
                ...
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="text-center space-y-6">
                        ...
                        <p className="text-2xl md:text-3xl font-serif italic text-white/90 leading-relaxed">
                            &quot;Every handwritten name, every memory retrieved, is a physical barrier against the void.&quot;
                        </p>
                    </div>

                    <div className="prose prose-invert prose-lg md:prose-xl mx-auto space-y-6 text-white/70 font-light leading-loose">
                        <p>
                            Khalil and Mariam, the last remaining documenters, confront the monstrous Audit — a sterile, digital consciousness obsessed with achieving Absolute Clarity by wiping every name, every story, and every structure from existence.
                        </p>
                        <p>
                            Their defense is a worn leather ledger and a single, defiant act: The Naming. As they search for the last secrets buried beneath the &quot;hollow ground,&quot; they must face the possibility that the ultimate horror is not forgetting, but the relentless act of being remembered by a world that wants you gone.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-zinc-950 border-t border-white/5">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center tracking-tight text-white/90">The Last Documenters</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <TopicCard title="The Audit" description="A sterile, digital consciousness obsessed with Absolute Clarity — wiping every name from existence." />
                        <TopicCard title="The Naming" description="Every handwritten name is a physical barrier against the void — resistance through documentation." />
                        <TopicCard title="The Northern Sector" description="Stalking through ruins, hunted by soul-consuming Hollow Ones and the Final Manifestation." />
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-black border-t border-white/10">
                <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-white/90 font-medium">Children of the Olive #5</p>
                    </div>
                    <div className="space-y-2">
